...
void range_test(const std::string &ssid, 
    ...
    luna::GetHistoryMsgReq req;
    luna::GetHistoryMsgRsp rsp;
...
void recent_test(const std::string &ssid, int count) {
    ...
    luna::MsgStorageService_Stub stub(channel.get());
    luna::GetRecentMsgReq req;
    luna::GetRecentMsgRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_chat_session_id(ssid);
...
void search_test(const std::string &ssid, const std::string &key) {
    ...
    luna::MsgStorageService_Stub stub(channel.get());
    luna::MsgSearchReq req;
    luna::MsgSearchRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_chat_session_id(ssid);
...
int main(int argc,char * argv[])
{
    ...
    boost::posix_time::ptime stime(boost::posix_time::time_from_string("2023-08-02 00:00:00"));
