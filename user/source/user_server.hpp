...
namespace luna{
    class UserServiceImpl : public luna::UserService{
        public:
        ...
        virtual void GetPhoneVerifyCode(::google::protobuf::RpcController* controller,
            ...
            // 3.生成验证码（目前仅设为1234 可申请短信平台sdk后发送真实验证码）
            string code_id=uuid();
            string code="1234";
            // 4. 构造验证码 ID，添加到 redis 验证码映射键值索引中
        ...
        virtual void GetUserInfo(::google::protobuf::RpcController* controller,
            ...
            if (!user->avatar_id().empty())
            {
                ...
                luna::GetSingleFileReq req;
                luna::GetSingleFileRsp rsp;
        ...
        virtual void GetMultiUserInfo(::google::protobuf::RpcController* controller,
            ...
            luna::FileService_Stub stub(channel.get());
            luna::GetMultiFileReq req;
            luna::GetMultiFileRsp rsp;
            req.set_request_id(request->request_id());
            for (auto &user : users) {
        ...
        virtual void SetUserAvatar(::google::protobuf::RpcController* controller,
            ...
            luna::FileService_Stub stub(channel.get());
            luna::PutSingleFileReq req;
            luna::PutSingleFileRsp rsp;
            req.set_request_id(request->request_id());
...
class UserServer {
    public:
        ...
        UserServer(const luna::Discovery::ptr service_discoverer, 
            const luna::Registry::ptr &reg_client,
    ...
    private:
        luna::Discovery::ptr _service_discoverer;
        luna::Registry::ptr _registry_client;
