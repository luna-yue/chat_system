...
namespace luna{
class FriendServiceImpl : public luna::FriendService {
    public:
        FriendServiceImpl(
        ...
        virtual void GetFriendList(::google::protobuf::RpcController* controller,
            ...
            ::luna::GetFriendListRsp* response,
        ...
        virtual void FriendRemove(::google::protobuf::RpcController* controller,
            const ::luna::FriendRemoveReq* request,
            ::luna::FriendRemoveRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendAdd(::google::protobuf::RpcController* controller,
            const ::luna::FriendAddReq* request,
            ::luna::FriendAddRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendAddProcess(::google::protobuf::RpcController* controller,
            const ::luna::FriendAddProcessReq* request,
            ::luna::FriendAddProcessRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendSearch(::google::protobuf::RpcController* controller,
            const ::luna::FriendSearchReq* request,
            ::luna::FriendSearchRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetPendingFriendEventList(::google::protobuf::RpcController* controller,
            const ::luna::GetPendingFriendEventListReq* request,
            ::luna::GetPendingFriendEventListRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetChatSessionList(::google::protobuf::RpcController* controller,
            const ::luna::GetChatSessionListReq* request,
            ::luna::GetChatSessionListRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void ChatSessionCreate(::google::protobuf::RpcController* controller,
            const ::luna::ChatSessionCreateReq* request,
            ::luna::ChatSessionCreateRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetChatSessionMember(::google::protobuf::RpcController* controller,
            const ::luna::GetChatSessionMemberReq* request,
            ::luna::GetChatSessionMemberRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
