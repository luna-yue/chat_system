...
void apply_test(const std::string &uid1, const std::string &uid2) {
    ...
    luna::FriendAddReq req;
    luna::FriendAddRsp rsp;
...
void get_apply_list(const std::string &uid1) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::GetPendingFriendEventListReq req;
    luna::GetPendingFriendEventListRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
    brpc::Controller cntl;
...
void process_apply_test(const std::string &uid1, bool agree, const std::string &apply_user_id) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::FriendAddProcessReq req;
    luna::FriendAddProcessRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
    req.set_agree(agree);
...
void search_test(const std::string &uid1, const std::string &key) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::FriendSearchReq req;
    luna::FriendSearchRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
...
void friend_list_test(const std::string &uid1) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::GetFriendListReq req;
    luna::GetFriendListRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
    brpc::Controller cntl;
...
void remove_test(const std::string &uid1, const std::string &uid2) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::FriendRemoveReq req;
    luna::FriendRemoveRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
...
void create_css_test(const std::string &uid1, const std::vector<std::string> &uidlist) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::ChatSessionCreateReq req;
    luna::ChatSessionCreateRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
...
void cssmember_test(const std::string &uid1, const std::string &cssid) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::GetChatSessionMemberReq req;
    luna::GetChatSessionMemberRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
...
void csslist_test(const std::string &uid1) {
    ...
    luna::FriendService_Stub stub(channel.get());
    luna::GetChatSessionListReq req;
    luna::GetChatSessionListRsp rsp;
    req.set_request_id(luna::uuid());
    req.set_user_id(uid1);
    brpc::Controller cntl;
